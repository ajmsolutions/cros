...
//======================================
#define BASKET_CLOSE_NUM_STEPS       9  // How many steps it takes to close the basket [NOTE: ensure SERVO_POS_OPEN % BASKET_CLOSE_NUM_STEPS == 0]
#define BASKET_CLOSE_STEP_DELAY_MS   250 // How long (ms) to wait between each 'step' when closing
